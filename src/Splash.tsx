...
import MyForm from "@/components/info-form";
  ...
  return (
    <main className="w-full h-full flex items-center justify-center bg-primary-200 p-4 bg-[length:auto_50%] lg:bg-auto bg-colorWash bg-no-repeat bg-right-top">
      <div className="flex flex-col gap-8 lg:gap-12 items-center max-w-full lg:max-w-3xl">
        ...
        <p>
          We have created a real-time voice activity detection (VAD) model that
          can detect voice activity in real-time. This particular demo is
          running on a Silero VAD model that is pre-trained on the OpenSLR
          dataset. The server running this demo is not GPU-enabled, so expect
          the performance to be even better on a GPU-enabled server.
        </p>
        ...
        <footer className="flex flex-col lg:gap-2">
          <p className="text-neutral-500">
            @2024, Neutral Base. All rights reserved
          </p>
        </footer>
      </div>
    </main>
